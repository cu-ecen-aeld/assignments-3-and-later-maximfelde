...
cd ${OUTDIR}
if [ ! -d "${OUTDIR}/assignments-3-and-later-maximfelde" ]
then
    git clone https://github.com/cu-ecen-aeld/assignments-3-and-later-maximfelde.git
fi

# TODO: Copy the finder related scripts and executables to the /home directory
# on the target rootfs
cd assignments-3-and-later-maximfelde/finder-app
make clean
